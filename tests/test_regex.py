...
class TestRegex(unittest.TestCase):
    ...
    def test_simone(self):
        ...
        self.assertTrue(dfa_abacb.accepts("aba"))
        self.assertTrue(dfa_abacb.accepts("abaca"))
        self.assertTrue(dfa_abacb.accepts("abacababaca"))
        self.assertFalse(dfa_abacb.accepts("abacababacab"))
        self.assertFalse(dfa_abacb.accepts("cababacab"))
        self.assertFalse(dfa_abacb.accepts("a"))
